...
(function () {
  ...
  var P = {
    ...
    gut:       { name: 'Gut Microbiome Test', cart: '/store/gut-microbiome/', href: '/testing/gut-microbiome/', tile: 'test-gut', price: 18000,
    ...
    oral:      { name: 'Oral Microbiome Test', cart: '/store/oral-microbiome/', href: '/testing/oral-microbiome/', tile: 'test-oral', price: 15000,
    ...
    carrier:   { name: 'Carrier Screening Test', cart: '/store/carrier-screening/', href: '/testing/carrier-screening/', tile: 'test-carrier', price: 39000,
                 blurb: 'Reads the recessive conditions you could pass to a child, long before it becomes an urgent question.' },
    newborn:   { name: 'Newborn Screening Test', cart: '/store/newborn-screening/', href: '/testing/newborn-screening/', tile: 'test-newborn', price: 29500,
                 blurb: 'Screening in the first months turns invisible risks into decisions you can act on, when early care matters most.' },
    sports:    { name: 'Sports Performance Test', cart: '/store/sports-performance/', href: '/testing/sports-performance/', tile: 'test-sports', price: 22000,
